  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        SizedBox(width: 4),
        Text("Зарегистрируйтесь!", style: TextStyle(color: Colors.green.shade800, fontWeight: FontWeight.bold),)
      ],
    );
  }
}
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8.0),
            child: Text("Или войти через", style: TextStyle(color: Colors.black, fontSize: 15)),
          ),
